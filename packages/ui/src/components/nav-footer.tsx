...
import { SidebarFooter, SidebarMenu, SidebarMenuItem } from "@workspace/ui/components/sidebar";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
          ...
          <div className="flex items-center gap-2 justify-between">
                  ...
                  >
                    <div className="space-y-1 text-xs">
                      ...
                      <p className="text-muted-foreground">
                        More details about the current user or section can be displayed here.
                      </p>
                    </div>
                  </TooltipContent>
                </Tooltip>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="pb-2">
                ...
                <DropdownMenuItem>
                  <BookmarkPlus size={16} className="mr-2 opacity-80" aria-hidden="true" />
                  Add Bookmark
                </DropdownMenuItem>
                <DropdownMenuItem>
